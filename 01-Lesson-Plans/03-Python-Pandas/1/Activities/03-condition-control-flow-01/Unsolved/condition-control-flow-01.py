...
# Else, print the string "This animal is neither Godzilla nor Mothra!".
    ...
    print("This animal is neither Godzilla nor Mothral!")
...
print("I drive Farley around San Francisco in my Prius")
...
total_cost = rent_cost + utilites_cost + food_cost + transportation_cost + computer_cost 
...
if total_cost <= budget:
    ...
    print("You're over budge by" + str(total_cost -budget))
...
if rent_cost > utilites_cost + food_cost + transportation_cost:
