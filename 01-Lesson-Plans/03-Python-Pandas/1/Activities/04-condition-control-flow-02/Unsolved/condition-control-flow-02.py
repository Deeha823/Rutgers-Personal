...
c2_savings = (c2_yearly_rent + c2_yearly_expenses)
...
if c1_location == c1_location:
    print("Mr. Farley comes from the home of the Raiders!" + '.')
elif c1_location == c1_location:
    print("Mr. Farley comes from the home of 49ers" + '.')
else:
    ("Mr. Farley doesn't hail from sports town" + '.') 
...
if c1_monthly_rent > c2_monthly_rent: 
    print("Mr. Farley pays more rent than Mr. Sunggles.")
elif c1_monthly_rent < c2_monthly_rent:
    print("Mr. Farley pays less rent than Mr. Sunggles.")
elif c1_monthly_rent == c2_monthly_rent:
    print("Mr. Farley rent is equal to Mr. Snuggles.")
...
if c1_monthly_expense > c2_monthly_expenses: 
    print("Mr. Farley has more expenses than Mr. Snuggles.")
elif c1_monthly_expense < c2_monthly_expenses:
...
if c1_perfession == c2_profession:
    print("Look a Web Developer and an Accountan")
else:
