...
statement_one = "Programmers: " + first_name + " " + last_name + "is a" + nationality + " " + profession + "born in" + " " + str(birth_year) + "."
print(statement_one)
...
statmement_two = "She is commonly referred to as the" " " + known_for + "."
print(statmement_two)
...
statmente_three = "In" " " + str(year_of_publish) + " " "she published the first Algorithm, the" " " + first_algorithm + ", at the age of 27"
print(statmente_three)
